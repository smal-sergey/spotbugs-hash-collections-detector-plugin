...
public class StreamCollectToSetWithFieldTest extends BaseDetectorTest {
    private static final Logger log = LoggerFactory.getLogger(StreamCollectToSetWithFieldTest.class);
